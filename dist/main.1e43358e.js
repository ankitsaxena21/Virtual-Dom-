...
var diff = function diff(vOldNode, vNewNode) {
  ...
  } // doing the same thing with children and attributes nodes
...
var _default = diff;
exports.default = _default;
},{"./render":"src/vdom/render.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
...
// here createVApp is simpliar to creating a component in react js
var createVApp = function createVApp(count) {
  return (0, _createElement.default)('div', {
    ...
    children: [(0, _createElement.default)('input'), (0, _createElement.default)('h1', {
      attrs: {
        id: "title"
      },
...
console.log("virtual dom as html", $app); // html format of virtual dom (i.e div containing img, count and input)

var $rootEl = (0, _mount.default)($app, document.getElementById('app'));
setInterval(function () {
  var vNewApp = createVApp(Math.floor(Math.random() * 10));
  var patch = (0, _diff.default)(vApp, vNewApp); // this patch fn will make the required changes in the html format of virtual dom

  $rootEl = patch($rootEl);
  vApp = vNewApp;
}, 1000);
},{"./vdom/createElement":"src/vdom/createElement.js","./vdom/render":"src/vdom/render.js","./vdom/mount":"src/vdom/mount.js","./vdom/diff":"src/vdom/diff.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
